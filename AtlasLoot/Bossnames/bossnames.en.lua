...
AtlasLootBossNames = {
    ...
    BlackwingLair = {
        ...
        BabbleBoss["Broodlord Lashlayer"], BabbleBoss["Firemaw"],
        BabbleBoss["Ebonroc"], BabbleBoss["Flamegor"], BabbleBoss["Chromaggus"],
        BabbleBoss["Nefarian"]
    },

    CFRTheSlavePens = {BabbleBoss["Quagmirran"]},

    CFRTheUnderbog = {BabbleBoss["The Black Stalker"]},
    ...
    Common = {AL["Trash Mobs"]},

    CoTOldHillsbradFoothills = {
        BabbleBoss["Epoch Hunter"] .. " (" .. AL["CoT1"] .. ")"
    },

    CoTTheBlackMorass = {BabbleBoss["Aeonus"] .. " (" .. AL["CoT2"] .. ")"},
    ...
    GruulsLair = {
        BabbleBoss["High King Maulgar"], BabbleBoss["Gruul the Dragonkiller"]
    },

    HCRamparts = {
        BabbleBoss["Omor the Unscarred"] .. " (" ..
    ...
    MagtheridonsLair = {BabbleBoss["Magtheridon"]},

    MoltenCore = {
        BabbleBoss["Lucifron"], BabbleBoss["Magmadar"], BabbleBoss["Gehennas"],
        BabbleBoss["Garr"], BabbleBoss["Shazzrah"], BabbleBoss["Baron Geddon"],
        BabbleBoss["Golemagg the Incinerator"],
        BabbleBoss["Sulfuron Harbinger"], BabbleBoss["Ragnaros"],
        AL["Trash Mobs"]
    },

    Naxxramas = {
        BabbleBoss["Patchwerk"], BabbleBoss["Grobbulus"], BabbleBoss["Gluth"],
        BabbleBoss["Thaddius"], BabbleBoss["Anub'Rekhan"],
        BabbleBoss["Grand Widow Faerlina"], BabbleBoss["Maexxna"],
        BabbleBoss["Instructor Razuvious"], BabbleBoss["Gothik the Harvester"],
        BabbleBoss["The Four Horsemen"], BabbleBoss["Noth the Plaguebringer"],
        BabbleBoss["Heigan the Unclean"], BabbleBoss["Loatheb"],
        BabbleBoss["Sapphiron"], BabbleBoss["Kel'Thuzad"]
    },

    OnyxiasLair = {BabbleBoss["Onyxia"]},
    ...
    TKMechanar = {BabbleBoss["Pathaleon the Calculator"] .. " (Mechanar)"},
    ...
    TKTheArcatraz = {BabbleBoss["Harbinger Skyriss"] .. " (Arcatraz)"},
    ...
    SMCathedral = {
        ...
        BabbleBoss["Highlord Dracien"] .. " (" ..
            BabbleZone["Scarlet Monastery 2"] .. ")",
        BabbleBoss["Vindicator Berean"] .. " (" ..
            BabbleZone["Scarlet Monastery 2"] .. ")",
        BabbleBoss["King Midas"] .. " (" .. BabbleZone["Scarlet Monastery 2"] ..
            ")",
        BabbleBoss["King Midas Heroic"] .. " (" ..
            BabbleZone["Scarlet Monastery 2"] .. ")"
    },
    ...
    BlackrockDepths2 = {
        ...
        BabbleBoss["Cratoriun"] .. " (" .. BabbleZone["Blackrock Depths 2"] ..
            ")", BabbleBoss["Nerothar the Tormentor"] .. " (" ..
            BabbleZone["Blackrock Depths 2"] .. ")",
        BabbleBoss["Blood Guard Gungo"] .. " (" ..
            BabbleZone["Blackrock Depths 2"] .. ")",
        BabbleBoss["Volcanus"] .. " (" .. BabbleZone["Blackrock Depths 2"] ..
            ")",
        BabbleBoss["Lord Ellcrys"] .. " (" .. BabbleZone["Blackrock Depths 2"] ..
            ")", BabbleBoss["Grand Overseer Balgannon"] .. " (" ..
            BabbleZone["Blackrock Depths 2"] .. ")",
    ...
    OnysLair = {
        ...
        BabbleBoss["Dreadscale Heroic"] .. " (" .. BabbleZone["Onyxia's Lair 2"] ..
            ")",
    ...
    BlackwingHold = {
        ...
        BabbleBoss["Chromatic Huntsman Varguk"] .. " (" ..
            BabbleZone["Blackwing Hold"] .. ")",
