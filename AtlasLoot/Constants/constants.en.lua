...
AL:RegisterTranslations("enUS", function()
    return {
        ...
        ["Artifacts1"] = true,
        ["Artifacts2"] = true,
        ["New Customs Search"] = true,
        ["New Customs Search 1"] = true,
        ["New Customs Search 2"] = true,
        ["New Customs Search 3"] = true,
        ["New Customs Search 4"] = true,
        ["New Customs Search 5"] = true,
        ["New Customs Search 6"] = true,
        ["New Customs Search 7"] = true,
        ["New Customs Search 8"] = true,
        ["New Customs Search 9"] = true,
        ["New Customs Search 10"] = true,
        ["New Customs Search 11"] = true,
        ["New Customs Search 12"] = true,
        ["New Customs Search 13"] = true,
        ["New Customs Search 14"] = true,
        ["New Customs Search"] = true,
        ["World of Chris"] = true,
        ["Event Reward"] = true,
        ["Upper Deck Game Card Item"] = true,
        ["Junk"] = true,
        ["ID: #"] = true,
        ["Player: #"] = true,
        ["- GM: #"] = true,
        ["Donate Item"] = true,
        ["Wrath of Arugal Trash"] = true,
        ["WoA Attunement"] = true,
        ["WOC Buff Scroll"] = true,
        ["WOC Customs"] = true,
        ["Ancient Ranger Armor"] = true,
        ["Dark Brotherhood Regalia"] = true,
        ["Valliant Regalia"] = true,
        ["Christmas 08"] = true,
        ["Collectables"] = true,
        ["Item Enhancements"] = true,
        ["Item Enhancements 1"] = true,
        ["Item Enhancements 2"] = true,
        ["Frostmourne Customs"] = true,
        ["Scarlet Monastery 2 Loot"] = true,
        ["Scarlet Monastery Loot"] = true,
        ["Professions"] = true,
        ...
        ["Trade in with sunmote for item below"] = true,
        ["Rare"] = true,
        ["Heroic"] = true,
        ["Summon"] = true,
        ["Random"] = true,
        ...
        ["World of Chris Customs"] = true,
        ["World of Chris Customs 1"] = true,
        ["World of Chris Customs 2"] = true,
        ["World of Chris Customs 3"] = true,
        ["World of Chris Customs 4"] = true,
        ["World of Chris Customs 5"] = true,
        ...
        -- Tier X Sets
        ["Emerald Harness"] = true,
        ["Emerald Raiment"] = true,
        ["Emerald Regalia"] = true,
        ["Ancient Ranger Armor"] = true,
        ["Dark Brotherhood Regalia"] = true,
        ["Valliant Armor"] = true,
        ["Valliant Battlegear"] = true,
        ["Valliant Raiment"] = true,
        ["Holy Brotherhood Absolution"] = true,
        ["Holy Brotherhood Regalia"] = true,
        ["Venom Lord Armor"] = true,
        ["Stormlord Harness"] = true,
        ["Stormlord Raiment"] = true,
        ["Stormlord Regalia"] = true,
        ["Maelstrom Raiment"] = true,
        ["Dark Executioner Armor"] = true,
        ["Dark Executioner Battlegear"] = true,

        -- Tier 8 Sets
        ["Cenarius Harness"] = true,
        ["Cenarius Raiment"] = true,
        ["Cenarius Regalia"] = true,
        ["Deathstalker Armor"] = true,
        ["Bloodmage Regalia"] = true,
        ["Vindicator's Armor"] = true,
        ["Vindicator's Battlegear"] = true,
        ["Vindicator's Raiment"] = true,
        ["Holy Absolution"] = true,
        ["Holy Regalia"] = true,
        ["Master Assassin Armor"] = true,
        ["Stormbringer Harness"] = true,
        ["Stormbringer Raiment"] = true,
        ["Stormbringer Regalia"] = true,
        ["Ancient Horror's Raiment"] = true,
        ["Defiant Armor"] = true,
        ["Defiant Battlegear"] = true,
