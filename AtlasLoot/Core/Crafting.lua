...
function AtlasLoot_CraftingMenu()
	...
	--Jewelcrafting
	AtlasLootMenuItem_6_Name:SetText((GetSpellInfo(25229)));
	...
	--Leatherworking
	AtlasLootMenuItem_7_Name:SetText((GetSpellInfo(2108)));
	...
	--First Aid
	AtlasLootMenuItem_12_Name:SetText((GetSpellInfo(3273)));
	...
	AtlasLootMenuItem_18_Icon:SetTexture("Interface\\Icons\\INV_Sword_1H_Blacksmithing_02");
	AtlasLootMenuItem_18.lootpage="CraftedWeapons1";
	AtlasLootMenuItem_18:Show();
	--Skinning
	AtlasLootMenuItem_13_Name:SetText((GetSpellInfo(8613)));
	AtlasLootMenuItem_13_Extra:SetText("");
	AtlasLootMenuItem_13_Icon:SetTexture("Interface\\Icons\\INV_Misc_Pelt_Wolf_01");
	AtlasLootMenuItem_13.lootpage="Skinning1";
	AtlasLootMenuItem_13:Show();
	--Herbalism
	AtlasLootMenuItem_14_Name:SetText((GetSpellInfo(2366)));
	AtlasLootMenuItem_14_Extra:SetText("");
	AtlasLootMenuItem_14_Icon:SetTexture("Interface\\Icons\\Trade_Herbalism");
	AtlasLootMenuItem_14.lootpage="Herbalism1";
	AtlasLootMenuItem_14:Show();
	--Fishing
	AtlasLootMenuItem_14_Name:SetText((GetSpellInfo(7620)));
	AtlasLootMenuItem_14_Extra:SetText("");
	AtlasLootMenuItem_14_Icon:SetTexture("Interface\\Icons\\Trade_Fishing");
	AtlasLootMenuItem_14.lootpage="Fishing";
	AtlasLootMenuItem_14:Show();
...
function AtlasLootCraftedSetMenu()
	...
	AtlasLootMenuItem_1_Name:SetText(RED..GetSpellInfo(2018));
	...
	AtlasLootMenuItem_12_Name:SetText(RED..GetSpellInfo(2018));
	...
	AtlasLootMenuItem_14:Show();
	--Tailoring Header
	AtlasLootMenuItem_16_Name:SetText(RED..GetSpellInfo(3908));
	...
	AtlasLootMenuItem_26_Extra:SetText(ORANGE..GetSpellInfo(26798));
	...
	AtlasLootMenuItem_27_Extra:SetText(ORANGE..GetSpellInfo(26801));
	...
	AtlasLootMenuItem_28_Extra:SetText(ORANGE..GetSpellInfo(26797));
...
function AtlasLootCraftedSetMenu2()
	...
	AtlasLootMenuItem_1_Name:SetText(RED..GetSpellInfo(2108));
	...
	AtlasLootMenuItem_12_Extra:SetText(ORANGE..GetSpellInfo(10658));
	...
	AtlasLootMenuItem_24_Extra:SetText(ORANGE..GetSpellInfo(10656));
	...
	AtlasLootMenuItem_25_Extra:SetText(ORANGE..GetSpellInfo(10656));
...
function AtlasLoot_TailoringMenu()
	...
	AtlasLootMenuItem_16_Name:SetText(select(2, GetSpellInfo(3101)));
	AtlasLootMenuItem_16_Extra:SetText("");
	AtlasLootMenuItem_16_Icon:SetTexture("Interface\\Icons\\Trade_Tailoring");
...
function AtlasLoot_SkinningMenu()
	for i = 1, 30, 1 do
		getglobal("AtlasLootItem_"..i):Hide();
	end
	for i = 1, 30, 1 do
	...
	getglobal("AtlasLootItemsFrame_PREV"):Hide();
	--Apprentice
	AtlasLootMenuItem_1_Name:SetText(select(2, GetSpellInfo(8613)));
	AtlasLootMenuItem_1_Extra:SetText("|cffFF8400Show ID #|cffFF00008613 |cffFF8400Teach ID #|cffFF00008615");
	AtlasLootMenuItem_1_Icon:SetTexture("Interface\\Icons\\INV_Misc_Pelt_Wolf_01");
	AtlasLootMenuItem_1.lootpage = "Skinning1";
	AtlasLootMenuItem_1:Show();
	for i = 1, 30, 1 do
		getglobal("AtlasLootMenuItem_"..i.."_Extra"):Show();
	end
	AtlasLoot_BossName:SetText("|cffFFFFFF"..GetSpellInfo(8615));
	AtlasLoot_SetItemInfoFrame(AtlasLoot_AnchorFrame);
end

function AtlasLoot_HerbalismMenu()
	for i = 1, 30, 1 do
		getglobal("AtlasLootItem_"..i):Hide();
	end
	for i = 1, 30, 1 do
	...
	getglobal("AtlasLootItemsFrame_PREV"):Hide();
	--Apprentice
	AtlasLootMenuItem_1_Name:SetText(select(2, GetSpellInfo(2366)));
	AtlasLootMenuItem_1_Extra:SetText("|cffFF8400Show ID #|cffFF00002368 |cffFF8400Teach ID #|cffFF00002372");
	AtlasLootMenuItem_1_Icon:SetTexture("Interface\\Icons\\Trade_Herbalism");
	AtlasLootMenuItem_1.lootpage = "Herbalism1";
	AtlasLootMenuItem_1:Show();
	for i = 1, 30, 1 do
		getglobal("AtlasLootMenuItem_"..i.."_Extra"):Show();
	end
	AtlasLoot_BossName:SetText("|cffFFFFFF"..GetSpellInfo(2366));
	AtlasLoot_SetItemInfoFrame(AtlasLoot_AnchorFrame);
end

function AtlasLoot_FishingMenu()
	for i = 1, 30, 1 do
		getglobal("AtlasLootItem_"..i):Hide();
	end
	for i = 1, 30, 1 do
	...
	getglobal("AtlasLootItemsFrame_PREV"):Hide();
	--Apprentice
	AtlasLootMenuItem_1_Name:SetText(select(2, GetSpellInfo(7620)));
	AtlasLootMenuItem_1_Extra:SetText("|cffFF8400Show ID #|cffFF00002368 |cffFF8400Teach ID #|cffFF00002372");
	AtlasLootMenuItem_1_Icon:SetTexture("Interface\\Icons\\Trade_Fishing");
	AtlasLootMenuItem_1.lootpage = "Fishing1";
	AtlasLootMenuItem_1:Show();
	for i = 1, 30, 1 do
		getglobal("AtlasLootMenuItem_"..i.."_Extra"):Show();
	end
