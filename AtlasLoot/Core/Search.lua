...
local modules = { "AtlasLoot_BCInstances", "AtlasLoot_Crafting", "AtlasLoot_OldInstances", "AtlasLoot_RepFactions", "AtlasLoot_SetsandPvP", "AtlasLoot_Spells", "AtlasLoot_WorldLoot" };
local currentPage = 1;
