...
function AtlasLoot_FixText(text)
    ...
    text = gsub(text, "#w21#", BabbleInventory["GM Weapon"]);
    ...
    text = gsub(text, "#m30#", AL["World of Chris"]);
    text = gsub(text, "#m31#", AL["Event Reward"]);
    text = gsub(text, "#m32#", AL["Upper Deck Game Card Item"]);
    text = gsub(text, "#m33#", AL["Junk"]);
    text = gsub(text, "#m34#", AL["ID: #"]);
    text = gsub(text, "#m35#", AL["Player: #"]);
    text = gsub(text, "#m36#", AL["- GM: #"]);
    text = gsub(text, "#m37#", AL["Donate Item"]);
    text = gsub(text, "#m38#", AL["Unknown"]);
    text = gsub(text, "#m39#", AL["Wrath of Arugal Trash"]);
    text = gsub(text, "#m40#", AL["WoA Attunement"]);
    text = gsub(text, "#m41#", AL["WOC Buff Scroll"]);
    text = gsub(text, "#m42#", AL["Trade in with sunmote for item below"]);
    ...
    -- Tier X Sets
    text = gsub(text, "#txs1_1#", AL["Emerald Harness"]);
    text = gsub(text, "#txs1_2#", AL["Emerald Raiment"]);
    text = gsub(text, "#txs1_3#", AL["Emerald Regalia"]);
    text = gsub(text, "#txs2#", AL["Ancient Ranger Armor"]);
    text = gsub(text, "#txs3#", AL["Dark Brotherhood Regalia"]);
    text = gsub(text, "#txs4_1#", AL["Valliant Armor"]);
    text = gsub(text, "#txs4_2#", AL["Valliant Battlegear"]);
    text = gsub(text, "#txs4_3#", AL["Valliant Raiment"]);
    text = gsub(text, "#txs4_4#", AL["Valliant Regalia"]);
    text = gsub(text, "#txs5_1#", AL["Holy Brotherhood Absolution"]);
    text = gsub(text, "#txs5_2#", AL["Holy Brotherhood Regalia"]);
    text = gsub(text, "#txs6#", AL["Venom Lord Armor"]);
    text = gsub(text, "#txs7_1#", AL["Stormlord Harness"]);
    text = gsub(text, "#txs7_2#", AL["Stormlord Raiment"]);
    text = gsub(text, "#txs7_3#", AL["Stormlord Regalia"]);
    text = gsub(text, "#txs8#", AL["Maelstrom Raiment"]);
    text = gsub(text, "#txs9_1#", AL["Dark Executioner Armor"]);
    text = gsub(text, "#txs9_2#", AL["Dark Executioner Battlegear"]);

    -- Tier 8 Sets
    text = gsub(text, "#t8s1_1#", AL["Cenarius Harness"]);
    text = gsub(text, "#t8s1_2#", AL["Cenarius Raiment"]);
    text = gsub(text, "#t8s1_3#", AL["Cenarius Regalia"]);
    text = gsub(text, "#t8s2#", AL["Deathstalker Armor"]);
    text = gsub(text, "#t8s3#", AL["Bloodmage Regalia"]);
    text = gsub(text, "#t8s4_1#", AL["Vindicator's Armor"]);
    text = gsub(text, "#t8s4_2#", AL["Vindicator's Battlegear"]);
    text = gsub(text, "#t8s4_3#", AL["Vindicator's Raiment"]);
    text = gsub(text, "#t8s5_1#", AL["Holy Absolution"]);
    text = gsub(text, "#t8s5_2#", AL["Holy Regalia"]);
    text = gsub(text, "#t8s6#", AL["Master Assassin Armor"]);
    text = gsub(text, "#t8s7_1#", AL["Stormbringer Harness"]);
    text = gsub(text, "#t8s7_2#", AL["Stormbringer Raiment"]);
    text = gsub(text, "#t8s7_3#", AL["Stormbringer Regalia"]);
    text = gsub(text, "#t8s8#", AL["Ancient Horror's Raiment"]);
    text = gsub(text, "#t8s9_1#", AL["Defiant Armor"]);
    text = gsub(text, "#t8s9_2#", AL["Defiant Battlegear"]);
    ...
    -- World of Chris
    text = gsub(text, "#woc1#", AL["Christmas 08"]);

    -- Text Colouring
    text = gsub(text, "=q0=", "|cff9d9d9d"); --Grey
    text = gsub(text, "=q1=", "|cffFFFFFF"); --White?
    text = gsub(text, "=q2=", "|cff1eff00"); --Green?
    ...
    text = gsub(text, "=ec1=", "|cffFF8400"); --Orange?
    text = gsub(text, "=ds=", "|cffFFd200"); --Yellow?
    text = gsub(text, "=at=", "|cffe6cc80"); --Artifact
    ...
    text = gsub(text, "#woc#", "|TInterface\\AddOns\\AtlasLoot\\Images\\WoC:0|t");
