...
AtlasLoot_DewDropDown = {
	...
	[6] = {
		[AL["Sets/Collections"]] = {
			...
			[13] = {
				{ AL["Tier X Sets"], "TXSets", "Submenu" },
			},
			[14] = {
				{ AL["Tier 8 Sets"], "T8Sets", "Submenu" },
			},
			[15] = {
			...
			[18] = {
				{ AL["Arena 4 PvP Sets"], "Arena4PvPArmor", "Submenu" },
			},
			[19] = {
				["Alterac Valley 2 Sets"] = {
					["Alliance PvP Sets"] = { "Alliance PvP Sets", "AVAlliance", "Submenu" },
					["Horde PvP Sets"] = { "Horde PvP Sets", "AVHorde", "Submenu" },
					["Non Set Items"] = { "Non Set Items", "AVNonSet", "Submenu" },
				},
			},
			[20] = {
			...
			[25] = {
				{ AL["Artifact Items"], "Artifacts", "Table" },
			},
			[26] = {
				{ AL["Blizzard Collectables"], "BlizzardCollectables1", "Table" },
			},
			[27] = {
				{ AL["Legendary Items"], "Legendaries", "Table" },
			},
			[28] = {
				{ AL["Rare Mounts"], "RareMounts1", "Table" },
			},
			[29] = {
				{ AL["Tabards"], "Tabards1", "Table" },
			},
			[30] = {
	...
	[7] = {
		[AL["PvP Rewards"]] = {
			...
			[13] = { { AtlasLoot_TableNames["Hellfire"][1], "Hellfire", "Table" }, },
			[14] = { { AtlasLoot_TableNames["Nagrand1"][1], "Nagrand1", "Table" }, },
			[15] = { { AtlasLoot_TableNames["Terokkar"][1], "Terokkar", "Table" }, },
			[16] = { { AtlasLoot_TableNames["Zangarmarsh"][1], "Zangarmarsh", "Table" }, },
		},
	},
	[8] = {
...
AtlasLoot_DewDropDown_SubTables = {
	...
	["BlackrockDepths2"] = {
		{ BabbleBoss["Valroth"], "BRDValroth" },
		{ BabbleBoss["Cratoriun"], "BRDCratoriun" },
		{ BabbleBoss["Nerothar the Tormentor"], "BRDNerothar" },
		{ BabbleBoss["Blood Guard Gungo"], "BRDGungo" },
		{ BabbleBoss["Volcanus"], "BRDVolcanus" },
		{ BabbleBoss["Lord Ellcrys"], "BRDEllcrys" },
		{ BabbleBoss["Grand Overseer Balgannon"], "BRDBalgannon" },
		{ BabbleBoss["Lady Weezuz"], "BRDWeezuz" },
		{ AL["Trash Mobs"], "BRDTrashMobs" },
	},
	["LowerBlackrock"] = {
	...
	["GuthrotsLab"] = {
		{ BabbleBoss["Derpenstein"], "Derpenstein" },
		{ BabbleBoss["Guth'rot"], "Guthrot" },
	},
	["Karazhan"] = {
	...
	["MoltenCore2"] = {
		{ BabbleBoss["Ragnaros"], "NewRagnaros" },
	},
	["Naxxramas"] = {
	...
	["WorldsEnd"] = {
		{ BabbleBoss["Aventine"], "WEAventine" },
		{ BabbleBoss["Micrah"], "WEMicrah" },
		{ BabbleBoss["Lord Maximus"], "WEMaximus" },
		{ BabbleBoss["Seer Akaldor"], "WEAkaldor" },
		{ BabbleBoss["Seris"], "WESeris" },
		{ AL["Trash Mobs"], "WETrash" },
	},
	["VoidHold"] = {
		{ BabbleBoss["Crystalcore Defender"], "VoidHoldDefender" },
		{ BabbleBoss["Xa'os"], "VoidHoldXaos" },
	},
	...
	["Deadmines2"] = {
		...
		{ BabbleBoss["Sneed's Shredder"], "DMSneedShredder" },
		{ BabbleBoss["Edwin VanCleef"], "DMEdwinVanCleef" },
	},


  --Grotto
	["Grotto"] = {
		{ BabbleBoss["UnUn"], "GUnun" },
		{ BabbleBoss["Gerald Snowdrift"], "GGerald" },
		{ BabbleBoss["Advisor Netheran"], "GAdvisor" },
		{ BabbleBoss["Palinho"], "GPalinho" },
		{ BabbleBoss["Telarion"], "GTelarion" },
		{ BabbleBoss["Shade of Naal"], "GShadeOfNaal" },
		{ BabbleBoss["Grinchmas"], "GGrinchmas" },
	},


	["AVAlliance"] = {
		{ "AV 2 Sets (Priest)", "AVAlliancePriest" },
		{ "AV 2 Sets (Mage)", "AVAllianceMage" },
		{ "AV 2 Sets (Warlock)", "AVAllianceWarlock" },
		{ "AV 2 Sets (Druid)", "AVAllianceDruid" },
		{ "AV 2 Sets (Rogue)", "AVAllianceRogue" },
		{ "AV 2 Sets (Shaman)", "AVAllianceShaman" },
		{ "AV 2 Sets (Hunter)", "AVAllianceHunter" },
		{ "AV 2 Sets (Paladin)", "AVAlliancePaladin" },
		{ "AV 2 Sets (Warrior)", "AVAllianceWarrior" },
		{ "AV 2 Sets (Weapons)", "AVAllianceWeapons" },
	},
	["AVHorde"] = {
		{ "AV 2 Sets (Priest)", "AVHordePriest" },
		{ "AV 2 Sets (Mage)", "AVHordeMage" },
		{ "AV 2 Sets (Warlock)", "AVHordeWarlock" },
		{ "AV 2 Sets (Druid)", "AVHordeDruid" },
		{ "AV 2 Sets (Rogue)", "AVHordeRogue" },
		{ "AV 2 Sets (Shaman)", "AVHordeShaman" },
		{ "AV 2 Sets (Hunter)", "AVHordeHunter" },
		{ "AV 2 Sets (Paladin)", "AVHordePaladin" },
		{ "AV 2 Sets (Warrior)", "AVHordeWarrior" },
		{ "AV 2 Sets (Weapons)", "AVHordeWeapons" },
	},
	["AVNonSet"] = {
		{ "AV 2 Sets (Non Set 1)", "AVNonSet1" },
		{ "AV 2 Sets (Non Set 2)", "AVNonSet2" },
	},
	["WorldBosses"] = {
	...
	["SMCath"] = {
		{ BabbleBoss["Larsh"], "SMCathLarsh" },
		{ BabbleBoss["Highlord Dracien"], "SMCathDracien" },
		{ BabbleBoss["Vindicator Berean"], "SMCathBerean" },
		{ BabbleBoss["King Midas"], "SMCathMidas" },
		{ BabbleBoss["King Midas Heroic"], "SMCathMidasHC" },
	},
	["OnysLair"] = {
		{ BabbleBoss["Dreadscale"], "OnysLairDreadscale" },
		{ BabbleBoss["Dreadscale Heroic"], "OnysLairDreadscaleHC" },
		{ BabbleBoss["Illidan"], "OnysLairIllidan" },
	},
	...
	["Lvl70TokenRewards"] = {
		...
		{ AtlasLoot_TableNames["HardModeAccessories2"][1], "HardModeAccessories2" },
	...
	["TXSets"] = {
		{ BabbleClass["Druid"], "TXDruid" },
		{ BabbleClass["Hunter"], "TXHunter" },
		{ BabbleClass["Mage"], "TXMage" },
		{ BabbleClass["Paladin"], "TXPaladin" },
		{ BabbleClass["Priest"], "TXPriest" },
		{ BabbleClass["Rogue"], "TXRogue" },
		{ BabbleClass["Shaman"], "TXShaman" },
		{ BabbleClass["Warlock"], "TXWarlock" },
		{ BabbleClass["Warrior"], "TXWarrior" },
	},
	["T8Sets"] = {
		{ BabbleClass["Druid"], "T8Druid" },
		{ BabbleClass["Hunter"], "T8Hunter" },
		{ BabbleClass["Mage"], "T8Mage" },
		{ BabbleClass["Paladin"], "T8Paladin" },
		{ BabbleClass["Priest"], "T8Priest" },
		{ BabbleClass["Rogue"], "T8Rogue" },
		{ BabbleClass["Shaman"], "T8Shaman" },
		{ BabbleClass["Warlock"], "T8Warlock" },
		{ BabbleClass["Warrior"], "T8Warrior" },
	},
	["ZGSets"] = {
	...
	["AV2Rewards"] = {
		{ AtlasLoot_TableNames["AVGreywind"][1], "AVGreywind" },
		{ AtlasLoot_TableNames["AVFiznik"][1], "AVFiznik" },
		{ AtlasLoot_TableNames["AVFrostskull"][1], "AVFrostskull" },
		{ AtlasLoot_TableNames["AVArchmage"][1], "AVArchmage" },
		{ AtlasLoot_TableNames["AVBlademaster"][1], "AVBlademaster" },
		{ "Lokholar the Ice Lord", "AVLokhCloth1" },
		{ "Ivus the Forest Lord", "AVIvusCloth1" },
	},
	["ABRewards"] = {
