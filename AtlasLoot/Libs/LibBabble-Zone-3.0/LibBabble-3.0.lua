...
if not LibBabble then return end
...
function prototype:SetBaseTranslations(base)
    ...
    for k, v in pairs(base) do if v == true then base[k] = k end end
end
...
function prototype:SetCurrentTranslations(current)
    ...
    if current == true then
        ...
        if oldCurrent then
            for k in pairs(oldCurrent) do oldCurrent[k] = nil end
            for k, v in pairs(current) do oldCurrent[k] = v end
            current = oldCurrent
        else
            db.current = current
        end
