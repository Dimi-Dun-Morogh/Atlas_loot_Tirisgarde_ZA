...
do
    ...
    if LibBabble then
        ...
        for k, v in pairs(LibBabble) do LibBabble[k] = nil end
        LibBabble.data = data

        local tablesToDB = {}
        for namespace, db in pairs(data) do
            for k, v in pairs(db) do tablesToDB[v] = db end
        end
        ...
        local function initReverse(module, reverse)
            local db = tablesToDB[module]
            for k in pairs(reverse) do reverse[k] = nil end
            for k, v in pairs(db.current) do reverse[v] = k end
        ...
        function prototype:SetBaseTranslations(base)
            ...
            if oldBase then
                for k in pairs(oldBase) do oldBase[k] = nil end
                for k, v in pairs(base) do oldBase[k] = v end
                base = oldBase
            else
                db.base = base
            end
            for k, v in pairs(base) do
                if v == true then base[k] = k end
            end
        end

        local function init(module)
            local db = tablesToDB[module]
            if db.lookup then initLookup(module, db.lookup) end
            if db.reverse then initReverse(module, db.reverse) end
            db.reverseIterators = nil
        end
        ...
        function LibBabble:New(namespace, minor)
            ...
            if not oldminor then
                local db = {module = module}
                data[namespace] = db
                tablesToDB[module] = db
            else
                for k, v in pairs(module) do module[k] = nil end
            end
...
elseif GAME_LOCALE == "deDE" then
    lib:SetCurrentTranslations{
        ...
        ["Blackrock Depths 2"] = "Blackrock Depths 2",
        ...
        ["Onyxia's Lair"] = "Onyxia's Lair 2",
        ["BlackwingHold"] = "BlackwingHold",
        ["Orgrimmar"] = "Orgrimmar",
        ["Ratchet"] = "Ratschet",
        ...
        ["Cathedral"] = "Cathedral",
        ["Scarlet Monastery 2"] = "Scarlet Monastery 2",
...
elseif GAME_LOCALE == "frFR" then
    lib:SetCurrentTranslations{
        ...
        ["Naxxramas"] = "Naxxramas",
        ["Onyxia's Lair 2"] = "Onyxia's Lair 2",
        ["Orgrimmar"] = "Orgrimmar",
        ["Ratchet"] = "Cabestan",
...
elseif GAME_LOCALE == "esMX" then
    lib:SetCurrentTranslations{
        ...
        ["Blackrock Depths"] = "Profundidades de Roca Negra",
        ["Blackrock Depths 2"] = "Blackrock Depths 2",
        ["Deadmines2"] = "deadmines 2",
        ["Zul Farrak 2"] = 'zf2',
        ["Blackrock Mountain"] = "Montaña Roca Negra",
        ["Blackrock Spire"] = "Cumbre de Roca Negra",
        ["Blackwing Lair"] = "Guarida Alanegra",
        ["Blackwing Hold"] = 'your mom',
        ["Blasted Lands"] = "Las Tierras Devastadas",
        ["Booty Bay"] = "Bahía del Botín",
        ["Burning Steppes"] = "Las Estepas Ardientes",
        ["Darkshore"] = "Costa Oscura",
