...
-----------------
  ...
  --Scarlet Monastery 2 - Cathedral
	AtlasLoot_TableNames["SMCathLarsh"] = { BabbleBoss["Larsh"], "AtlasLootExpansionItems" };
	AtlasLoot_TableNames["SMCathDracien"] = { BabbleBoss["Highlord Dracien"], "AtlasLootExpansionItems" };
  ...
  --Blackrock Depths 2
	...
	AtlasLoot_TableNames["BRDBalgannon"] = { BabbleBoss["Grand Overseer Balgannon"], "AtlasLootExpansionItems" };
	AtlasLoot_TableNames["BRDWeezuz"] = { BabbleBoss["Lady Weezuz"], "AtlasLootExpansionItems" };
	AtlasLoot_TableNames["BRDWeezuz2"] = { BabbleBoss["Lady Weezuz"], "AtlasLootExpansionItems" };
	AtlasLoot_TableNames["BRDTrashMobs"] = { AL["Trash Mobs"].." ("..BabbleZone["Blackrock Depths 2"]..")", "AtlasLootExpansionItems" };
  ...
  --Molten Core 2
	AtlasLoot_TableNames["NewRagnaros"] = { BabbleBoss["Ragnaros"], "AtlasLootExpansionItems" };

  --Guthrot's Lab
	AtlasLoot_TableNames["Derpenstein"] = { BabbleBoss["Derpenstein"], "AtlasLootExpansionItems" };
	AtlasLoot_TableNames["Guthrot"] = { BabbleBoss["Guth'rot"], "AtlasLootExpansionItems" };

  --Grinchmass Grotto
  	AtlasLoot_TableNames["GUnun"] = { BabbleBoss["UnUn"], "AtlasLootExpansionItems"};
	AtlasLoot_TableNames["GGerald"] = { BabbleBoss["Gerald Snowdrift"], "AtlasLootExpansionItems"};
	AtlasLoot_TableNames["GAdvisor"] = { BabbleBoss["Advisor Netheran"], "AtlasLootExpansionItems"};
	AtlasLoot_TableNames["GPalinho"] = { BabbleBoss["Palinho"], "AtlasLootExpansionItems"};
	AtlasLoot_TableNames["GTelarion"] = { BabbleBoss["Telarion"], "AtlasLootExpansionItems"};
	AtlasLoot_TableNames["GShadeOfNaal"] = { BabbleBoss["Shade of Naal"], "AtlasLootExpansionItems"};
	AtlasLoot_TableNames["GGrinchmas"] = { BabbleBoss["Grinchmas"], "AtlasLootExpansionItems"};
  ...
  --World's End
	AtlasLoot_TableNames["WEAventine"] = { BabbleBoss["Aventine"], "AtlasLootExpansionItems" };
	AtlasLoot_TableNames["WEAventine2"] = { BabbleBoss["Aventine"], "AtlasLootExpansionItems" };
	AtlasLoot_TableNames["WEMicrah"] = { BabbleBoss["Micrah"], "AtlasLootExpansionItems" };
	AtlasLoot_TableNames["WEMicrah2"] = { BabbleBoss["Micrah"], "AtlasLootExpansionItems" };
	AtlasLoot_TableNames["WEMaximus"] = { BabbleBoss["Lord Maximus"], "AtlasLootExpansionItems" };
	AtlasLoot_TableNames["WEMaximus2"] = { BabbleBoss["Lord Maximus"], "AtlasLootExpansionItems" };
	AtlasLoot_TableNames["WEAkaldor"] = { BabbleBoss["Seer Akaldor"], "AtlasLootExpansionItems" };
	AtlasLoot_TableNames["WEAkaldor2"] = { BabbleBoss["Seer Akaldor"], "AtlasLootExpansionItems" };
	AtlasLoot_TableNames["WESeris"] = { BabbleBoss["Seris"], "AtlasLootExpansionItems" };
	AtlasLoot_TableNames["WESeris2"] = { BabbleBoss["Seris"], "AtlasLootExpansionItems" };
	AtlasLoot_TableNames["WETrash"] = { AL["Trash Mobs"].." ("..BabbleZone["World's End"]..")", "AtlasLootExpansionItems" };
	AtlasLoot_TableNames["WETrash2"] = { AL["Trash Mobs"].." ("..BabbleZone["World's End"]..")", "AtlasLootExpansionItems" };
  --Zul'Aman
  ...
  --BlackwingHold
	AtlasLoot_TableNames["BWLKastyon"] = { BabbleBoss["Wrathcaster Kastyon"], "AtlasLootExpansionItems" };
  ...
  --Deadmines2
	...
	AtlasLoot_TableNames["DMEdwinVanCleef"] = { BabbleBoss["Edwin VanCleef"], "AtlasLootExpansionItems" };
...
------------
  ...
  --TX Sets
	AtlasLoot_TableNames["TXDruid"] = { BabbleClass["Druid"].." - "..AL["Tier X Sets"], "AtlasLootSetItems" };
	AtlasLoot_TableNames["TXDruid2"] = { BabbleClass["Druid"].." - "..AL["Tier X Sets"], "AtlasLootSetItems" };
	AtlasLoot_TableNames["TXHunter"] = { BabbleClass["Hunter"].." - "..AL["Tier X Sets"], "AtlasLootSetItems" };
	AtlasLoot_TableNames["TXMage"] = { BabbleClass["Mage"].." - "..AL["Tier X Sets"], "AtlasLootSetItems" };
	AtlasLoot_TableNames["TXPaladin"] = { BabbleClass["Paladin"].." - "..AL["Tier X Sets"], "AtlasLootSetItems" };
	AtlasLoot_TableNames["TXPaladin2"] = { BabbleClass["Paladin"].." - "..AL["Tier X Sets"], "AtlasLootSetItems" };
	AtlasLoot_TableNames["TXPriest"] = { BabbleClass["Priest"].." - "..AL["Tier X Sets"], "AtlasLootSetItems" };
	AtlasLoot_TableNames["TXRogue"] = { BabbleClass["Rogue"].." - "..AL["Tier X Sets"], "AtlasLootSetItems" };
	AtlasLoot_TableNames["TXShaman"] = { BabbleClass["Shaman"].." - "..AL["Tier X Sets"], "AtlasLootSetItems" };
	AtlasLoot_TableNames["TXShaman2"] = { BabbleClass["Shaman"].." - "..AL["Tier X Sets"], "AtlasLootSetItems" };
	AtlasLoot_TableNames["TXWarlock"] = { BabbleClass["Warlock"].." - "..AL["Tier X Sets"], "AtlasLootSetItems" };
	AtlasLoot_TableNames["TXWarrior"] = { BabbleClass["Warrior"].." - "..AL["Tier X Sets"], "AtlasLootSetItems" };
  --T8 Sets
	AtlasLoot_TableNames["T8Druid"] = { BabbleClass["Druid"].." - "..AL["Tier 8 Sets"], "AtlasLootSetItems" };
	AtlasLoot_TableNames["T8Druid2"] = { BabbleClass["Druid"].." - "..AL["Tier 8 Sets"], "AtlasLootSetItems" };
	AtlasLoot_TableNames["T8Hunter"] = { BabbleClass["Hunter"].." - "..AL["Tier 8 Sets"], "AtlasLootSetItems" };
	AtlasLoot_TableNames["T8Mage"] = { BabbleClass["Mage"].." - "..AL["Tier 8 Sets"], "AtlasLootSetItems" };
	AtlasLoot_TableNames["T8Paladin"] = { BabbleClass["Paladin"].." - "..AL["Tier 8 Sets"], "AtlasLootSetItems" };
	AtlasLoot_TableNames["T8Paladin2"] = { BabbleClass["Paladin"].." - "..AL["Tier 8 Sets"], "AtlasLootSetItems" };
	AtlasLoot_TableNames["T8Priest"] = { BabbleClass["Priest"].." - "..AL["Tier 8 Sets"], "AtlasLootSetItems" };
	AtlasLoot_TableNames["T8Rogue"] = { BabbleClass["Rogue"].." - "..AL["Tier 8 Sets"], "AtlasLootSetItems" };
	AtlasLoot_TableNames["T8Shaman"] = { BabbleClass["Shaman"].." - "..AL["Tier 8 Sets"], "AtlasLootSetItems" };
	AtlasLoot_TableNames["T8Shaman2"] = { BabbleClass["Shaman"].." - "..AL["Tier 8 Sets"], "AtlasLootSetItems" };
	AtlasLoot_TableNames["T8Warlock"] = { BabbleClass["Warlock"].." - "..AL["Tier 8 Sets"], "AtlasLootSetItems" };
	AtlasLoot_TableNames["T8Warrior"] = { BabbleClass["Warrior"].." - "..AL["Tier 8 Sets"], "AtlasLootSetItems" };

------------------------
--- Misc Collections ---
------------------------

	AtlasLoot_TableNames["Artifacts"] = { "Artifact Items", "AtlasLootSetItems" };
	AtlasLoot_TableNames["Artifacts2"] = { "Artifact Items", "AtlasLootSetItems" };
	AtlasLoot_TableNames["Artifacts3"] = { "Artifact Items", "AtlasLootSetItems" };
	...
	AtlasLoot_TableNames["Legendaries2"] = { "Legendary Items", "AtlasLootSetItems" };
	AtlasLoot_TableNames["Legendaries3"] = { "Legendary Items", "AtlasLootSetItems" };
	AtlasLoot_TableNames["RareMounts1"] = { AL["Rare Mounts"], "AtlasLootSetItems" };
	AtlasLoot_TableNames["RareMounts2"] = { AL["Rare Mounts"], "AtlasLootSetItems" };
...
--------------------
  ...
  --Kezal
	AtlasLoot_TableNames["KezalLethon1"] = { BabbleBoss["Kezal Lethon"], "AtlasLootWBItems" };
  --Ashwing
	AtlasLoot_TableNames["Ashwing1"] = { BabbleBoss["Ashwing"], "AtlasLootWBItems" };
  --Azuregos
...
-----------
  ...
  --Battlegrounds
   --Alterac Valley
	...
	-- AV 2
	AtlasLoot_TableNames["AVGreywind"] = { "Grey Wind", "AtlasLootBGItems" };
	AtlasLoot_TableNames["AVFrostskull"] = { "Frostskull", "AtlasLootBGItems" };
	AtlasLoot_TableNames["AVFiznik"] = { "Fiznik the Chopper", "AtlasLootBGItems" };

	AtlasLoot_TableNames["AVAlliancePriest"] = { "AV 2 Sets (Priest)", "AtlasLootSetItems" };
	AtlasLoot_TableNames["AVAllianceMage"] = { "AV 2 Sets (Mage)", "AtlasLootSetItems" };
	AtlasLoot_TableNames["AVAllianceWarlock"] = { "AV 2 Sets (Warlock)", "AtlasLootSetItems" };
	AtlasLoot_TableNames["AVAllianceDruid"] = { "AV 2 Sets (Druid)", "AtlasLootSetItems" };
	AtlasLoot_TableNames["AVAllianceRogue"] = { "AV 2 Sets (Rogue)", "AtlasLootSetItems" };
	AtlasLoot_TableNames["AVAllianceShaman"] = { "AV 2 Sets (Shaman)", "AtlasLootSetItems" };
	AtlasLoot_TableNames["AVAllianceHunter"] = { "AV 2 Sets (Hunter)", "AtlasLootSetItems" };
	AtlasLoot_TableNames["AVAlliancePaladin"] = { "AV 2 Sets (Paladin)", "AtlasLootSetItems" };
	AtlasLoot_TableNames["AVAllianceWarrior"] = { "AV 2 Sets (Warrior)", "AtlasLootSetItems" };
	AtlasLoot_TableNames["AVAllianceWeapons"] = { "AV 2 Sets (Weapons)", "AtlasLootSetItems" };

	AtlasLoot_TableNames["AVHordePriest"] = { "AV 2 Sets (Priest)", "AtlasLootSetItems" };
	AtlasLoot_TableNames["AVHordeMage"] = { "AV 2 Sets (Mage)", "AtlasLootSetItems" };
	AtlasLoot_TableNames["AVHordeWarlock"] = { "AV 2 Sets (Warlock)", "AtlasLootSetItems" };
	AtlasLoot_TableNames["AVHordeDruid"] = { "AV 2 Sets (Druid)", "AtlasLootSetItems" };
	AtlasLoot_TableNames["AVHordeRogue"] = { "AV 2 Sets (Rogue)", "AtlasLootSetItems" };
	AtlasLoot_TableNames["AVHordeShaman"] = { "AV 2 Sets (Shaman)", "AtlasLootSetItems" };
	AtlasLoot_TableNames["AVHordeHunter"] = { "AV 2 Sets (Hunter)", "AtlasLootSetItems" };
	AtlasLoot_TableNames["AVHordePaladin"] = { "AV 2 Sets (Paladin)", "AtlasLootSetItems" };
	AtlasLoot_TableNames["AVHordeWarrior"] = { "AV 2 Sets (Warrior)", "AtlasLootSetItems" };
	AtlasLoot_TableNames["AVHordeWeapons"] = { "AV 2 Sets (Weapons)", "AtlasLootSetItems" };

	AtlasLoot_TableNames["AVNonSet1"] = { "AV 2 Sets (Non Set 1)", "AtlasLootSetItems" };
	AtlasLoot_TableNames["AVNonSet2"] = { "AV 2 Sets (Non Set 2)", "AtlasLootSetItems" }

	-- Alliance
	AtlasLoot_TableNames["AVArchmage"] = { "Archmage Vargus", "AtlasLootBGItems" };
	AtlasLoot_TableNames["AVIvusCloth1"] = { "Ivus the Forest Lord (Cloth 1)", "AtlasLootBGItems" };
	AtlasLoot_TableNames["AVIvusCloth2"] = { "Ivus the Forest Lord (Cloth 2)", "AtlasLootBGItems" };
	AtlasLoot_TableNames["AVIvusLeather"] = { "Ivus the Forest Lord (Leather)", "AtlasLootBGItems" };
	AtlasLoot_TableNames["AVIvusMail"] = { "Ivus the Forest Lord (Mail)", "AtlasLootBGItems" };
	AtlasLoot_TableNames["AVIvusPlate"] = { "Ivus the Forest Lord (Plate)", "AtlasLootBGItems" };
	AtlasLoot_TableNames["AVIvusWeapons"] = { "Ivus the Forest Lord (Weapons)", "AtlasLootBGItems" };

	-- Horde
	AtlasLoot_TableNames["AVBlademaster"] = { "Blademaster Tor'Grak", "AtlasLootBGItems" };
	AtlasLoot_TableNames["AVLokhCloth1"] = { "Lokholar the Ice Lord (Cloth 1)", "AtlasLootBGItems" };
	AtlasLoot_TableNames["AVLokhCloth2"] = { "Lokholar the Ice Lord (Cloth 2)", "AtlasLootBGItems" };
	AtlasLoot_TableNames["AVLokhLeather"] = { "Lokholar the Ice Lord (Leather)", "AtlasLootBGItems" };
	AtlasLoot_TableNames["AVLokhMail"] = { "Lokholar the Ice Lord (Mail)", "AtlasLootBGItems" };
	AtlasLoot_TableNames["AVLokhPlate"] = { "Lokholar the Ice Lord (Plate)", "AtlasLootBGItems" };
	AtlasLoot_TableNames["AVLokhWeapons"] = { "Lokholar the Ice Lord (Weapons)", "AtlasLootBGItems" };
   --Arathi Basin
  ...
  --Misc Other PvP
	...
	AtlasLoot_TableNames["PvP70NonSet3"] = { AL["PvP Non-Set Epics"]..": "..BabbleInventory["Mail"].."/"..BabbleInventory["Plate"], "AtlasLootGeneralPvPItems" };
  	AtlasLoot_TableNames["PvP70NonSet1b"] = { AL["PvP Non-Set Epics"]..": "..AL["Accessories"], "AtlasLootGeneralPvPItems" };
	AtlasLoot_TableNames["PvP70NonSet2b"] = { AL["PvP Non-Set Epics"]..": "..BabbleInventory["Cloth"].."/"..BabbleInventory["Leather"], "AtlasLootGeneralPvPItems" };
	AtlasLoot_TableNames["PvP70NonSet3b"] = { AL["PvP Non-Set Epics"]..": "..BabbleInventory["Mail"].."/"..BabbleInventory["Plate"], "AtlasLootGeneralPvPItems" };
...
-------------
  ...
  --Menus, the entry does nothing, but makes the generalised loot table code less complex
	...
	AtlasLoot_TableNames["T8SET"] = { "dummy", "dummy" };
	AtlasLoot_TableNames["TXSET"] = { "dummy", "dummy" };
